...
"""
    setup!(cvi::GD53, sample::Array{T, 1}) where {T<:RealFP}
"""
function setup!(cvi::GD53, sample::Array{T, 1}) where {T<:RealFP}
...
end # setup!(cvi::GD53, sample::Array{T, 1}) where {T<:RealFP}
